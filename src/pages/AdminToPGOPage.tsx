...
// Removed auto-generation date key helper; trackingId is now user-provided.
...
export default function AdminToPGOPage() {
  ...
  const confirmReturnRecord = async () => {
    ...
    try {
      ...
      await adminToPGOService.updateRecord(recordToReturn, {
      ...
      setSuccess('Record returned to administrator successfully');
  ...
  const filteredRecords = records.filter(record =>
    ...
    (record.status || 'Pending') === activeTab && (
  ...
  // Removed nextTrackingId; trackingId is user-entered.
  ...
  return (
    ...
    <div className="flex h-screen bg-background">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-2xl font-bold bg-gradient-to-r from-rose-600 to-rose-500 bg-clip-text text-transparent">Admin to PGO Records</h1>

                <p className="text-sm text-gray-500">Manage internal administrative transfers</p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {user?.name && (
                ...
                <div className="flex items-center gap-2.5 px-4 py-2.5 bg-gray-50 rounded-xl border border-gray-200">
                  ...
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-rose-500 to-rose-600 flex items-center justify-center shrink-0 shadow-sm">
          ...
          <div className="border-0 shadow-md rounded-lg bg-white overflow-hidden h-full flex flex-col">
            ...
            <div className="px-4 sm:px-6 py-4 border-b bg-gradient-to-r from-gray-50 to-white flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div>
                ...
                <h2 className="text-lg font-semibold text-gray-900">Admin to PGO</h2>

                <p className="text-sm text-gray-500 mt-1">Manage and view all admin to PGO records</p>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div className="relative w-full sm:w-64">
                  ...
                  <Input
                    ...
                    className="pl-10 h-10 border-gray-300 focus:border-rose-500 focus:ring-rose-500"
                ...
                <Dialog open={isDialogOpen} onOpenChange={handleDialogOpenChange}>
                  ...
                  <DialogTrigger asChild>
                    ...
                    <Button
                      ...
                      className="gap-2 bg-rose-600 hover:bg-rose-700 w-full sm:w-auto h-10"
                    ...
                    <div className="grid gap-4 py-4 overflow-x-hidden max-w-full">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          disabled={editingId ? user?.role !== 'admin' : false}
            ...
            <div className="bg-card rounded-lg border shadow-md overflow-hidden flex-1 flex flex-col">
                  ...
                  {filteredRecords.length === 0 ? (
                    ...
                    filteredRecords.map((record) => (
                      ...
                      <TableRow key={record.id} className="hover:bg-muted/50">
                        ...
                        <TableCell className={`text-sm py-3 px-4 text-center whitespace-normal wrap-break-word max-w-[120px] ${record.status === 'Completed' ? 'text-green-600 font-medium' : 'text-red-600'}`}>{record.dateTimeOut ? formatDateTimeWithoutSeconds(record.dateTimeOut) : '-'}</TableCell>
                        ...
                        <TableCell className="text-sm py-3 px-4 text-center whitespace-normal wrap-break-word max-w-[240px]">{record.particulars}</TableCell>
      ...
      {/* Return to Administrator Confirmation Modal */}

      <Dialog open={returnConfirmOpen} onOpenChange={setReturnConfirmOpen}>

        <DialogContent className="sm:max-w-md">

          <DialogTitle className="text-lg font-semibold">Return to Administrator</DialogTitle>

          <DialogDescription>

            Provide a reason for returning this record to the administrator. The status will be set back to "Pending".
          ...
          <div className="flex gap-3 justify-end pt-6">
            ...
            <Button
              ...
              className="px-6 text-white border-purple-600 bg-purple-600 hover:bg-purple-700"
