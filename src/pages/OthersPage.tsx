                    ...
                    {records.length > 0 ? (
                      records.map((record) => (
                        <TableRow key={record.id} className="hover:bg-gray-50">
                          <TableCell className="font-bold italic break-word whitespace-normal text-center text-xs text-indigo-600">{record.trackingId}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">{new Date(record.dateTimeIn).toLocaleString()}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs text-red-600">{record.dateTimeOut ? new Date(record.dateTimeOut).toLocaleString() : '-'}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs uppercase">{record.fullName}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">{record.designationOffice}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">{record.inclusiveDateStart} - {record.inclusiveDateEnd}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">{record.purpose}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">{formatCurrency(record.amount)}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">
                          ...
                          <TableCell className="break-word whitespace-normal text-center text-xs">{record.remarks || '-'}</TableCell>
                          <TableCell className="break-word whitespace-normal text-center text-xs">
                      ...
                      <TableRow>
                        <TableCell colSpan={12} className="text-center py-8 text-gray-500 break-word whitespace-normal">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900 mt-1">{selectedRecord.amount ? `₱${selectedRecord.amount}` : '-'}</p>
                  </div>
                  <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-end pt-4">
              ...
              <Button
                ...
                disabled={!timeOutData.dateTimeOut}
              >
                Record Time Out
              </Button>
            </div>
